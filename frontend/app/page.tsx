...
export default function Home() {
  const [modules] = useState([
    ...
    },
    {
      ...
      description:
        "Monitor driver behavior to prevent accidents caused by fatigue or distractions.",
      path: "/driver-alertness",
    },
    {
      title: "Accident Detection",
      description:
        "Automatically detect traffic accidents using camera feeds for quick response.",
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-3xl font-bold mb-6">
        AI-based Transportation System Dashboard
      </h1>
